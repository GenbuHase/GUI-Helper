 ...
 *#Copyright © 2015-2017 Genbu Project and Genbu Hase All Rights Reserved.
 *###########################################################################
/*/
...
var GUIHelper = {
	...
	Property: {
		...
		AddSeekBar: function (ID, Value, MaxValue, DragFuc, TouchFuc, ReleaseFuc) {
			...
			GUIHelper.SeekBars[ID].setOnSeekBarChangeListener(new android.widget.SeekBar.OnSeekBarChangeListener() {
